...
function get_group_bulletins(div_to_append, group_id, sort_by_field, order_by_value, number) {
  ...
  $.ajax({
    ...
    url: PARISH_URL_UPDATE + "/get_group_announcements.json/" + group_id + "/"+ sort_by_field + "/" + order_by_value,
    cache: false,
    type: 'get',
    dataType: 'jsonp',
    success: function(response) {
...
function get_group_events(div_to_append, group_id, sort_by_field, order_by_value, number) {
  ...
  $.ajax({
    ...
    url: PARISH_URL_UPDATE + "/get_group_events.json/" + group_id + "/"+ sort_by_field + "/" + order_by_value,
    cache: false,
    type: 'get',
    dataType: 'jsonp',
    success: function(response) {      
